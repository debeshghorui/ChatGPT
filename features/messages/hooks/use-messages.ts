...
import { queryKeys } from "@/features/utils/query-keys";
...
export function useMessages(conversationId: string | undefined) {
    return useQuery({
        queryKey: queryKeys.messages.byConversationId(conversationId ?? "none"),
    ...
    return useMutation({
        ...
        onSuccess: () => {
            void queryClient.invalidateQueries({
                queryKey: queryKeys.messages.byConversationId(conversationId),
            });
            void queryClient.invalidateQueries({
